...
void G5_Asibawatari_Clear::Initialize()
{
	...
	// ゲームクリア
	gameClear = std::make_unique<Sprite>("Data/Sprite/5.Asibawatari/GameClear.png");
...
// 終了化
void G5_Asibawatari_Clear::Finalize()
{
}

// 更新処理
void G5_Asibawatari_Clear::Update(float elapsedTime)
{
...
// 描画処理
void G5_Asibawatari_Clear::Render()
{
