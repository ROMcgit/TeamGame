...
public:
	...
	struct Material
	{
		...
		Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> SRV_Normal;    //ノーマルマップ
		Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> SRV_Roughness; //ラフネスマップ
		Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> SRV_Metallic;  //メタリックマップ
