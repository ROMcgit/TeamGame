...
Director::Director(DirectorManager* manager)
	: manager(manager)
{
}
...
// 演出の状態更新処理
void Director::UpdateDirectorState(float elapsedTime, bool updateDirectionTarget, bool rotation, float rotationSpeed)
{
	// 行列更新処理
	UpdateTransform();
...
// 当たり判定の位置を設定
void Director::CollisionPosSettings()
{
	collisionPos = {
...
// ターゲットを向く更新処理
void Director::UpdateDirectionTarget(float elapsedTime, bool rotation, float rotationSpeed)
{
	// ターゲット方向ベクトルを計算
...
// 大きさ更新処理
bool Director::UpdateScaleChange(float elapsedTime)
{
	//! 大きさを変更しないなら、処理を止める
	if (!scaleChange)
		return false;
...
// 単一軸のスケール変更更新処理
float Director::UpdateScaleAxis(float scale, float speed, bool scaleChangeUp, float toScaleChange, float elapsedTime)
{
	// 大きさ変更
...
//! マテリアルの色変更更新処理
bool Director::UpdateMaterialColorChange(float elapsedTime)
{
...
// 単一軸のマテリアルの色変更更新処理
float Director::UpdateMaterialColorAxis(float materialColor, float speed, bool materialColorChangeUp, float toMaterialColorChange, float elapsedTime)
{
	// マテリアルの色変更
...
//! 不透明度変更更新処理
bool Director::UpdateEffectOpacityChange(float elapsedTime)
{
	//! 不透明度を変更しないなら、処理を止める
	if (!opacityChange)
		return false;
...
//!エミッシブの色変更更新処理
bool Director::UpdateEmissiveColorChange(float elapsedTime)
{
...
// 単一軸のエミシッブの色変更更新処理
float Director::UpdateEmissiveColorAxis(float emissiveColor, float speed, bool emissiveColorChangeUp, float toEmissiveColorChange, float elapsedTime)
{
	//エミッシブの色変更
...
//! エミッシブの強さ変更更新処理
bool Director::UpdateEmissiveStrengthChange(float elapsedTime)
{
