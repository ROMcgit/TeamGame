#include "GS1_DarumasangaKoronda.h"
#include <imgui.h>
...
// コンストラクタ
GS1_DarumasangaKoronda::GS1_DarumasangaKoronda()
{
...
// 更新処理
void GS1_DarumasangaKoronda::Update(float elapsedTime)
{
	// ステート毎の更新処理
	switch (state)
	{
...
// HPなどの描画
void GS1_DarumasangaKoronda::SpriteRender(ID3D11DeviceContext* dc, Graphics& graphics)
{
}

// デバッグプリミティブ描画
void GS1_DarumasangaKoronda::DrawDebugPrimitive()
{
	// 基底クラスのデバッグプリミティブ描画
...
// 縄張り設定
void GS1_DarumasangaKoronda::SetTerritory(const DirectX::XMFLOAT3& origin, float range)
{
...
// ターゲット位置をランダム設定
void GS1_DarumasangaKoronda::SetRandomTargetPosition()
{
	// 縄張り範囲内でランダムな位置を生成
...
// 目標地点へ移動
void GS1_DarumasangaKoronda::MoveToTarget(float elapsedTime, float speedRate)
{
	// ターゲット方向への進行ベクトルを算出
...
// 待機ステートへ遷移
void GS1_DarumasangaKoronda::TransitionWaitState()
{
	state = State::Wait;
...
// 待機ステート更新処理
void GS1_DarumasangaKoronda::UpdateWaitState(float elapsedTime)
{
}

// プレイヤーとの接触処理
void GS1_DarumasangaKoronda::CollisionVsPlayer()
{
