...
void G2_Sundome_Tutorial::Initialize()
{
	...
	for (int i = 0; i < 3; i++)
	{
		std::string filePath = "Data/Sprite/2.Sundome/Tutorial" + std::to_string(i) + ".png";
...
// 終了化
void G2_Sundome_Tutorial::Finalize()
{
}

// 更新処理
void G2_Sundome_Tutorial::Update(float elapsedTime)
{
...
// 描画処理
void G2_Sundome_Tutorial::Render()
{
