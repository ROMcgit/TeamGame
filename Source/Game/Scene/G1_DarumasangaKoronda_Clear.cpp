...
void G1_DarumasangaKoronda_Clear::Initialize()
{
	...
	SceneGameSelect::clear.darumasangaKoronda = true;
...
// 終了化
void G1_DarumasangaKoronda_Clear::Finalize()
{
}

// 更新処理
void G1_DarumasangaKoronda_Clear::Update(float elapsedTime)
{
...
// 描画処理
void G1_DarumasangaKoronda_Clear::Render()
{
