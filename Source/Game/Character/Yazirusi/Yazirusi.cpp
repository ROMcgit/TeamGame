...
Yazirusi::Yazirusi(YazirusiManager* manager)
	: manager(manager)
{
...
// 当たり判定の位置を設定
void Yazirusi::CollisionPosSettings()
{
	collisionPos = {
...
// デバッグプリミティブ描画
void Yazirusi::DrawDebugPrimitive()
{
...
// 破棄
void Yazirusi::Destroy()
{
	manager->Remove(this);
}

// 更新行列処理
void Yazirusi::UpdateTransform()
{
